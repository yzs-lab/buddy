...
const en = {
  ...
  'statusBar.roundInProgress': 'In progress · round {n}',
  'statusBar.roundCompleted': 'Completed {n} round(s)',
  ...
  'statusBar.actor.running': 'Running',
  'statusBar.actor.bound': 'Session bound',
  'statusBar.actor.idle': 'Idle',
  'statusBar.actor.confirmEnd': 'Confirm end',
  'statusBar.actor.session': 'Session: {id}',
  'statusBar.actor.elapsed': 'Elapsed: {elapsed}',
  ...
  'statusBar.summary.countdown': 'Countdown',
  'statusBar.summary.maxRounds': 'Auto rounds',
  'statusBar.summary.nextRound': 'Next round',
...
const zhCN: typeof en = {
  ...
  'statusBar.roundInProgress': '进行中 第 {n} 轮',
  'statusBar.roundCompleted': '已完成 {n} 轮',
  ...
  'statusBar.actor.running': '运行中',
  'statusBar.actor.bound': '已绑定会话',
  'statusBar.actor.idle': '空闲',
  'statusBar.actor.confirmEnd': '待确认结束',
  'statusBar.actor.session': '会话：{id}',
  'statusBar.actor.elapsed': '耗时：{elapsed}',
  ...
  'statusBar.summary.countdown': '倒计时',
  'statusBar.summary.maxRounds': '自动轮次',
  'statusBar.summary.nextRound': '下一轮',
...
const zhTW: typeof en = {
  ...
  'statusBar.roundInProgress': '進行中 第 {n} 輪',
  'statusBar.roundCompleted': '已完成 {n} 輪',
  ...
  'statusBar.actor.running': '執行中',
  'statusBar.actor.bound': '已綁定工作階段',
  'statusBar.actor.idle': '閒置',
  'statusBar.actor.confirmEnd': '待確認結束',
  'statusBar.actor.session': '工作階段：{id}',
  'statusBar.actor.elapsed': '耗時：{elapsed}',
  ...
  'statusBar.summary.countdown': '倒數',
  'statusBar.summary.maxRounds': '自動輪次',
  'statusBar.summary.nextRound': '下一輪',
