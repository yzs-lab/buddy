...
const en = {
  ...
  'status.RUNNING_CURSOR': 'Cursor Agent running',
  ...
  'sidebar.menuOpenInVSCode': 'Open in VS Code',
  ...
  'settings.launcher.cursor.title': 'Cursor Agent configuration',
  'settings.launcher.cursor.label': 'Cursor Agent launch command',
  'settings.launcher.protocol': 'Command protocol',
  'settings.launcher.protocol.auto': 'Auto detect',
  'settings.launcher.protocol.contract': 'Buddy contract',
  'settings.launcher.protocol.hint': 'Use Auto for known CLIs and legacy contract commands. Select a native CLI when the command is a wrapper around it.',
  ...
  'settings.launcher.cursor.hint': 'A named Cursor Agent profile. Each profile has its own model, prompt and resumable session.',
  'settings.launcher.cursor.add': 'Add Cursor Agent',
  'settings.launcher.cursor.name': 'Profile name',
  'settings.launcher.cursor.command': 'CLI command',
  'settings.launcher.cursor.timeout': 'Round timeout (seconds)',
  'settings.launcher.cursor.model': 'Model',
  'settings.launcher.cursor.modelDefault': 'Cursor account default',
  'settings.launcher.cursor.modelsRefresh': 'Fetch models',
  'settings.launcher.cursor.modelsLoaded': '{n} models loaded via {source}',
  'settings.launcher.cursor.mode': 'Agent mode',
  'settings.launcher.cursor.sandbox': 'Sandbox',
  'settings.launcher.cursor.sandboxDefault': 'Cursor default',
  'settings.launcher.cursor.preset': 'Prompt preset',
  'settings.launcher.cursor.presetNone': 'No preset',
  'settings.launcher.cursor.force': 'Force command approval',
  'settings.launcher.cursor.trust': 'Trust workspace',
  'settings.launcher.cursor.approveMcps': 'Approve MCP servers',
  'settings.launcher.cursor.partialStream': 'Character-level stream',
  'settings.launcher.cursor.customPrompt': 'Profile-specific prompt',
  'settings.launcher.cursor.customPromptPlaceholder': 'Optional instructions appended only for this profile',
  'settings.launcher.cursor.env': 'Environment (KEY=value, one per line)',
  'settings.launcher.cursor.extraArgs': 'Additional CLI arguments (one per line)',
  'settings.launcher.cursor.extraArgsPlaceholder': '--plugin-dir\n/path/to/plugin',
  ...
  'settings.prompts.presets.title': 'Prompt presets',
  'settings.prompts.presets.desc': 'Reusable instructions selectable independently by each agent profile.',
  'settings.prompts.presets.add': 'Add preset',
  'settings.prompts.presets.empty': 'No prompt presets yet.',
  'settings.prompts.presets.name': 'Preset name',
  'settings.prompts.presets.prompt': 'Preset instructions',
  'settings.prompts.preset.newName': 'New preset',
  ...
  'shortcuts.find': 'Find in Conversation',
  ...
  'find.matches': 'Match {active} of {total}',
...
const zhCN: typeof en = {
  ...
  'status.RUNNING_CURSOR': 'Cursor Agent 运行中',
  'status.PAUSED': '已暂停',
  'status.FAILED': '失败',
  'status.DONE': '已完成',
  ...
  'sidebar.menuOpenInVSCode': '在 VS Code 中打开',
  ...
  'settings.launcher.cursor.title': 'Cursor Agent 配置',
  'settings.launcher.cursor.label': 'Cursor Agent 启动命令',
  'settings.launcher.protocol': '命令协议',
  'settings.launcher.protocol.auto': '自动检测',
  'settings.launcher.protocol.contract': 'Buddy 契约',
  'settings.launcher.protocol.hint': '已知 CLI 和旧版契约命令使用自动检测；命令是原生 CLI 包装器时，请明确选择对应 CLI。',
  ...
  'settings.launcher.cursor.hint': '一个可命名的 Cursor Agent 配置。每个配置拥有独立的模型、提示词和可续接会话。',
  'settings.launcher.cursor.add': '添加 Cursor Agent',
  'settings.launcher.cursor.name': '配置名称',
  'settings.launcher.cursor.command': 'CLI 命令',
  'settings.launcher.cursor.timeout': '单轮超时（秒）',
  'settings.launcher.cursor.model': '模型',
  'settings.launcher.cursor.modelDefault': '使用 Cursor 账户默认模型',
  'settings.launcher.cursor.modelsRefresh': '获取模型',
  'settings.launcher.cursor.modelsLoaded': '已通过 {source} 获取 {n} 个模型',
  'settings.launcher.cursor.mode': 'Agent 模式',
  'settings.launcher.cursor.sandbox': '沙箱',
  'settings.launcher.cursor.sandboxDefault': 'Cursor 默认设置',
  'settings.launcher.cursor.preset': '提示词预设',
  'settings.launcher.cursor.presetNone': '不使用预设',
  'settings.launcher.cursor.force': '自动批准命令',
  'settings.launcher.cursor.trust': '信任工作区',
  'settings.launcher.cursor.approveMcps': '自动批准 MCP',
  'settings.launcher.cursor.partialStream': '字符级流式输出',
  'settings.launcher.cursor.customPrompt': '此配置专用提示词',
  'settings.launcher.cursor.customPromptPlaceholder': '可选；只追加到此 Agent 配置',
  'settings.launcher.cursor.env': '环境变量（每行 KEY=value）',
  'settings.launcher.cursor.extraArgs': '额外 CLI 参数（每行一个）',
  'settings.launcher.cursor.extraArgsPlaceholder': '--plugin-dir\n/path/to/plugin',
  ...
  'settings.prompts.presets.title': '提示词预设',
  'settings.prompts.presets.desc': '可复用的指令，每个 Agent 配置可以独立选择。',
  'settings.prompts.presets.add': '添加预设',
  'settings.prompts.presets.empty': '还没有提示词预设。',
  'settings.prompts.presets.name': '预设名称',
  'settings.prompts.presets.prompt': '预设指令',
  'settings.prompts.preset.newName': '新预设',
  ...
  'find.noResults': '无结果',
  'find.matches': '第 {active} 个，共 {total} 个',
  'find.previous': '上一个',
  'find.next': '下一个',
  'find.close': '关闭',
...
const zhTW: typeof en = {
  ...
  'status.RUNNING_CURSOR': 'Cursor Agent 執行中',
  'status.PAUSED': '已暫停',
  'status.FAILED': '失敗',
  'status.DONE': '已完成',
  ...
  'sidebar.menuOpenInVSCode': '在 VS Code 中開啟',
  'sidebar.menuRemove': '移除',
  'sidebar.tooltipMore': '更多操作',
  ...
  'settings.launcher.cursor.title': 'Cursor Agent 設定',
  'settings.launcher.cursor.label': 'Cursor Agent 啟動指令',
  'settings.launcher.protocol': '指令協定',
  'settings.launcher.protocol.auto': '自動偵測',
  'settings.launcher.protocol.contract': 'Buddy 契約',
  'settings.launcher.protocol.hint': '已知 CLI 與舊版契約指令使用自動偵測；指令是原生 CLI 包裝器時，請明確選擇對應 CLI。',
  ...
  'settings.launcher.cursor.hint': '一個可命名的 Cursor Agent 設定。每個設定都有獨立的模型、提示詞與可續接工作階段。',
  'settings.launcher.cursor.add': '新增 Cursor Agent',
  'settings.launcher.cursor.name': '設定名稱',
  'settings.launcher.cursor.command': 'CLI 指令',
  'settings.launcher.cursor.timeout': '單輪逾時（秒）',
  'settings.launcher.cursor.model': '模型',
  'settings.launcher.cursor.modelDefault': '使用 Cursor 帳戶預設模型',
  'settings.launcher.cursor.modelsRefresh': '取得模型',
  'settings.launcher.cursor.modelsLoaded': '已透過 {source} 取得 {n} 個模型',
  'settings.launcher.cursor.mode': 'Agent 模式',
  'settings.launcher.cursor.sandbox': '沙箱',
  'settings.launcher.cursor.sandboxDefault': 'Cursor 預設設定',
  'settings.launcher.cursor.preset': '提示詞預設',
  'settings.launcher.cursor.presetNone': '不使用預設',
  'settings.launcher.cursor.force': '自動核准指令',
  'settings.launcher.cursor.trust': '信任工作區',
  'settings.launcher.cursor.approveMcps': '自動核准 MCP',
  'settings.launcher.cursor.partialStream': '字元級串流輸出',
  'settings.launcher.cursor.customPrompt': '此設定專用提示詞',
  'settings.launcher.cursor.customPromptPlaceholder': '可選；只附加到此 Agent 設定',
  'settings.launcher.cursor.env': '環境變數（每行 KEY=value）',
  'settings.launcher.cursor.extraArgs': '額外 CLI 參數（每行一個）',
  'settings.launcher.cursor.extraArgsPlaceholder': '--plugin-dir\n/path/to/plugin',
  ...
  'settings.prompts.presets.title': '提示詞預設',
  'settings.prompts.presets.desc': '可重複使用的指令，每個 Agent 設定可以獨立選擇。',
  'settings.prompts.presets.add': '新增預設',
  'settings.prompts.presets.empty': '尚無提示詞預設。',
  'settings.prompts.presets.name': '預設名稱',
  'settings.prompts.presets.prompt': '預設指令',
  'settings.prompts.preset.newName': '新預設',
  ...
  'find.label': '在對話中尋找',
  'find.placeholder': '在對話中尋找',
  'find.noResults': '無結果',
  'find.matches': '第 {active} 個，共 {total} 個',
  'find.previous': '上一個',
  'find.next': '下一個',
  'find.close': '關閉',
